...
ConstExpGroup: "[" ConstExp "]" {$$=NewAst("ConstExpGroup",yylineno,3,$1,$2,$3);cout << "ConstExpGroup <= [ConstExp]" << endl;}
...
ConstInitVal : ConstExp {$$=NewAst("ConstInitVal",yylineno,1,$1);}
        ...
        | error { return 1; }
;
ConstInitValGroup: ConstInitValGroup  {COUT(ConstInitValGroup);}
